define(['exports', 'mixin-deep', 'aurelia-logging', 'aurelia-dependency-injection', 'aurelia-templating', 'aurelia-path'], function (exports, _mixinDeep, _aureliaLogging, _aureliaDependencyInjection, _aureliaTemplating, _aureliaPath) {
  'use strict';
  ...
  var Config = exports.Config = function () {
    ...
    Config.prototype.configureDefaults = function configureDefaults(configs) {
      (0, _mixinDeep2.default)(this.defaults, configs);
    ...
    Config.prototype.configureNamespace = function configureNamespace(name) {
      ...
      (0, _mixinDeep2.default)(namespace, configs);
    ...
    Config.prototype.configure = function configure(config) {
      (0, _mixinDeep2.default)(this.namespaces, config);
